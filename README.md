...
- ♻️ Sustainable Organizational Performance
- 🎓 Higher Education Management
- 🕌 Islamic Spiritual Leadership
- 🌏 Emerging-Economy Management
- 👨‍💼 Leadership, HRM & Organizational Effectiveness
...
I have published **seven peer-reviewed journal articles** covering digital leadership, AI adoption, human–AI collaboration, electronic human resource management, employee engagement, higher education, remote work, and ChatGPT adoption.

---

## 1. Leadership Perception in Remote Work Environments
...
🔗 **DOI:**  
https://doi.org/10.33844/ijol.2026.60554
...
> *Research areas are overlapping; individual publications may contribute to more than one research area.*
...
My research experience spans **quantitative, qualitative, systematic review, and bibliometric methodologies**, with an increasing focus on hybrid analytical approaches.
...
Co-authored a **PRISMA 2020-compliant Scopus review** that screened **222 records** and synthesized **29 peer-reviewed studies**, using structured content analysis to identify dominant theories, methods, thematic mechanisms, and future research priorities at the **digital leadership–human–AI collaboration–sustainable performance** nexus.
...
Presented at the **International Student Colloquium Collaboration**, December 13, 2025.
...
- Provide guidance and resources for students pursuing international conferences, grants, and scholarships.
- Foster academic partnerships between UMY and external research institutions.
- Oversee career-development initiatives, including resume workshops, interview preparation, and professional mentorship.
- Integrate research activities into the ISA program calendar through cross-departmental collaboration.
...
- Designed supplementary teaching materials.
- Applied educational management principles to classroom facilitation and student progress tracking.

---

# 🔬 Collaborative Research

I collaborate with **Dr. Udin Udin** and UMY faculty on research involving:
...
Collaborative manuscripts have been developed for international peer-reviewed outlets, including journals associated with **Springer Nature**.
...
- CGPA: **3.91/4.00**
- EQF Level 7
- Academic requirements completed **July 2026**
...
- PLS-SEM (SmartPLS 4, R)
- Academic Writing & Scholarly Publishing
- Systematic Literature Review
- Bibliometric Analysis (VOSviewer)
- Citation & Reference Management
- APA 7 & DOI Verification
- Peer Review
- Manuscript Revision & Reviewer Response

## Technical & Professional

- SPSS / Statistical Reporting
- Machine Learning for Social Science (ANN, SHAP)
- Microsoft Word, Excel & PowerPoint
- Project Management
- Team Leadership
- Digital Collaboration (Zoom, Microsoft Teams, Google Meet)
- Research Dissemination & Academic Networking
...
|---|---:|---:|---:|---:|---:|
| Bengali (Native) | Native | Native | Native | Native | Native |
| English | B2 | B2 | B2 | B2 | B2 |
| Hindi | B2 | B2 | B2 | B2 | A2 |
| Indonesian | A2 | A2 | A2 | A2 | A2 |
...
My doctoral research agenda focuses on **leadership, organizational behavior, human resource management, and organizational effectiveness within the changing economic and technological landscapes of South and Southeast Asia**.

I am particularly interested in developing research on:

- Digital leadership and AI-enabled organizations
- Human–AI collaboration and employee outcomes
- Responsible and sustainable AI-enabled HRM
...
- Islamic organizational ethics and leadership
- Digital transformation in higher education and emerging economies

My methodological goal is to combine **rigorous theory development with advanced empirical methods**, including PLS-SEM, qualitative inquiry, bibliometric research, and hybrid SEM–machine-learning approaches.

---

# 🌱 Leadership, Volunteering & Academic Activities

- Director of Research and Professional Development, ISA UMY.
- Coordinator/contributor to the ISA International Research Bootcamp 2026.
- Invited peer reviewer for international academic journals.
- Active author across international journal production and peer-review pipelines.
- Participant in international conferences, summer courses, and interdisciplinary academic forums.
- Active community volunteer in social and educational outreach initiatives.
- Regular participant in management and leadership seminars.
- Interests: cross-cultural exploration, academic writing & journaling, business and leadership literature, and professional networking.

---

# 📫 Contact & Academic Profiles

- 📧 **Email:** israfil.munna.psc25@mail.umy.ac.id
...
- PLS-SEM and hybrid SEM–machine-learning research
- Emerging-market management

If you are a **researcher, PhD supervisor, doctoral applicant, journal editor, or academic institution** interested in collaboration, feel free to connect.

---

<p align="center">
  <b>Researching leadership, technology, and organizations for a more sustainable future.</b>
</p>
